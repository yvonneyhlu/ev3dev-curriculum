...
def main():
    ...
    rc1.on_red_up = lambda button_state: red_up(button_state)
    rc1.on_red_down = lambda button_state: red_down(button_state)
    rc1.on_blue_up = lambda button_state: blue_up(button_state)
    rc1.on_blue_down = lambda button_state: blue_down(button_state)
